      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="relative h-40 sm:h-56 w-full overflow-hidden shrink-0">
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-black/60 text-white backdrop-blur-md transition-transform hover:scale-110 hover:bg-black/80 cursor-pointer"
            >
              <X className="h-5 w-5" />
            </button>
            ...
            <div className="absolute bottom-4 left-6 right-6 flex items-end justify-between">
              <div>
                <span className="inline-block rounded-full bg-salvia/90 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-black shadow-md mb-2">
                  {classItem.level}
                </span>
